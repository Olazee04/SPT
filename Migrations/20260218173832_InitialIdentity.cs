        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetPage = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasProject = table.Column<bool>(type: "boolean", nullable: false),
                    IsMiniProject = table.Column<bool>(type: "boolean", nullable: false),
                    WeightPercentage = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    DifficultyLevel = table.Column<string>(type: "text", nullable: false),
                    PrerequisiteModuleId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextOfKinAddress = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectCompleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonCovered = table.Column<string>(type: "text", nullable: true),
                    PracticeDone = table.Column<bool>(type: "boolean", nullable: false),
                    QuizScore = table.Column<int>(type: "integer", nullable: true),
                    MiniProjectProgress = table.Column<int>(type: "integer", nullable: true),
                    Blocker = table.Column<string>(type: "text", nullable: true),
                    NextGoal = table.Column<string>(type: "text", nullable: true),
                    ...
                    MentorRating = table.Column<int>(type: "integer", nullable: true),
                    MentorResponse = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalTomorrow = table.Column<string>(type: "text", nullable: true),
                    Mood = table.Column<string>(type: "text", nullable: false),
                    UnderstandingRating = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
